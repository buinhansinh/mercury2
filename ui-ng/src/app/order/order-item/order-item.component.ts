...
import { debounceTime, distinctUntilChanged, switchMap, startWith, map, filter } from 'rxjs/operators';
...
export class OrderItemComponent implements OnInit {
    ...
    selectOffer(offer) {
        ...
        this.pricing$ = this.orderService.getPricing(offer.id, this.contactId, this.docType);
        this.stocks$ = offer.type === OfferType.PRODUCT ? this.inventoryService.getStock(offer.id) : of([]);
    }
